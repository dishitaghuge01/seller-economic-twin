...
const DICT = {
  ...
  "sec.forecast": { hi: "स्टॉक-आउट पूर्वानुमान", en: "Stockout forecast" },
  ...
  "demo.idle": { hi: "खाली", en: "Idle" },
  "demo.preparing": { hi: "डेमो तैयार हो रहा है…", en: "Preparing demo..." },
  ...
  "demo.resetSuccess": { hi: "डेमो रीसेट हो गया", en: "Demo reset" },
  "demo.confirmReset": { hi: "प्रगति रीसेट करें?", en: "Reset progress?" },
  "demo.confirmSub": { hi: "इस सत्र में किए गए कोई भी मैन्युअल बदलाव ओवरराइट हो जाएंगे।", en: "Any manual changes made during this session will be overwritten." },
  "demo.confirmYes": { hi: "हाँ, रीसेट करें", en: "Yes, reset" },
  "demo.confirmCancel": { hi: "रद्द करें", en: "Cancel" },
  "demo.startReplay": { hi: "डेमो रीप्ले शुरू करें", en: "Start demo replay" },
  ...
  "demo.stopped": { hi: "डेमो रोक दिया गया", en: "Demo stopped" },
  "demo.failed": { hi: "डेमो विफल हुआ", en: "Demo failed" },
  "demo.failedError": { hi: "डेमो विफल हुआ।", en: "Demo failed." },
  "demo.loadStatusError": { hi: "डेमो स्थिति लोड नहीं हो पाई।", en: "Unable to load demo status." },
  "demo.resetError": { hi: "डेमो रीसेट नहीं हो सका।", en: "Unable to reset demo." },
  "demo.pausedError": { hi: "रुका (त्रुटि)", en: "Paused (error)" },
  "demo.toastNotification": { hi: "व्हाट्सएप अलर्ट भेजा गया — व्हाट्सएप थ्रेड टैब देखें।", en: "WhatsApp alert sent — check the WhatsApp Thread tab." },
  "demo.logTitle": { hi: "डेमो लॉग", en: "Demo log" },
  "demo.defaultSku": { hi: "डेमो SKU", en: "Demo SKU" },
  "demo.logDay": { hi: (v) => `दिन ${v.day}:`, en: (v) => `Day ${v.day}:` },
  "demo.logNoAction": { hi: "कोई नोटिफिकेशन ज़रूरी नहीं।", en: "No notification needed." },
  "demo.logShock": { hi: "डिमांड गिर गई — मार्केट शिफ्ट पाया गया।", en: "demand dropped — market shift detected" },
  "demo.logAlertSent": { hi: "अलर्ट ट्रिगर हुआ — व्हाट्सएप नोटिफिकेशन भेजा गया।", en: "alert triggered — WhatsApp notification sent" },
  "demo.logCritical": { hi: "स्टॉक क्रिटिकल है — नोटिफिकेशन ज़रूरी नहीं।", en: "stock critical — no notification needed" },
  "demo.logWatch": { hi: "स्टॉक पर नज़र रखी जा रही है — नोटिफिकेशन ज़रूरी नहीं।", en: "stock under watch — no notification needed" },
  "demo.logPriceHeld": { hi: "दाम वही रखा गया — नोटिफिकेशन ज़रूरी नहीं।", en: "price held — no notification needed" },
